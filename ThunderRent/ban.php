...
<html>
<head>
	<title>Ban User - ThunderRent</title>
	...
	if (mysqli_query($connection, "UPDATE user_account SET userType = '$userType' WHERE userID = '$userID'")) {
		echo '
			<script type="text/javascript">
				alert("SUCCESS: User Type updated");
	...
	<div id="wrap">
		...
		<div id="admin">
			<form method="post">
				...
				<div class="info"><span>User Type:</span><input name="userType" type="radio" value="banned" checked>Ban <input name="userType" type="radio" value="user">Unban</div>
